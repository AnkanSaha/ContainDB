...
wget https://github.com/nexoral/ContainDB/releases/download/v9.20.48-stable/containDB_9.20.48-stable_amd64.deb

# Install the package
sudo dpkg -i containDB_9.20.48-stable_amd64.deb
